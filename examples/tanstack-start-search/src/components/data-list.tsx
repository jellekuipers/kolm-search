...
export function DataList(props: DataListProps) {
	return (
		<dl
			{...props}
			className="flex flex-col gap-2 text-sm lg:grid lg:auto-rows-fr lg:grid-cols-[auto_1fr]"
		/>
	);
}
...
export function DataListItem(props: DataListItemProps) {
	return (
		<div
			{...props}
			className="flex flex-col gap-2 lg:col-span-2 lg:grid lg:grid-cols-subgrid lg:items-center"
		/>
	);
}
